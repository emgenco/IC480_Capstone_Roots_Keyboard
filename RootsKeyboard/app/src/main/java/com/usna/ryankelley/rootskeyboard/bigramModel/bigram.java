package com.usna.ryankelley.rootskeyboard.bigramModel;


import com.usna.ryankelley.rootskeyboard.util.*;
import com.usna.ryankelley.rootskeyboard.util.PriorityQueue;
...
public class bigram {
    ...
    com.usna.ryankelley.rootskeyboard.util.PriorityQueue<String> final_probs;
    double uniCount;
    ...
    public bigram() {
        ...
        final_probs = new com.usna.ryankelley.rootskeyboard.util.PriorityQueue<String>();
        uniCount = 0;
