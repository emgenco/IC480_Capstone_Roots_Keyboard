package com.usna.ryankelley.rootskeyboard.util;
...
public class PriorityQueue <E> implements Iterator<E>, Serializable, Cloneable {
    ...
    public String[] next3Unchanged() {
        String[] array = new String[3];
        if (elements.size() > 3) {
            E first = peek();
            double first_pro = priorities[0];
            removeFirst();
            E second = peek();
            double second_pro = priorities[0];
            removeFirst();
            E third = peek();
            double third_pro = priorities[0];
            removeFirst();
            array[0] = first.toString();
            array[1] = second.toString();
            array[2] = third.toString();
            //add(first,first_pro);
            //add(second, second_pro);
            //add(third, third_pro);
        }
